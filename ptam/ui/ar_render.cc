  ...
  void ARRender<CameraType>::UploadVideoFrame()
  {
    ...
    if (rendermode == ORIGINAL)
    {
      GLfloat fa_texcoords[8] = {0, 0,
                                 (float)frametexture_width, 0,
                                 (float)frametexture_width, (float)frametexture_height,
                                 0, (float)frametexture_height};
  ...
  void ARRender<CameraType>::MapFBO2SystemFBO()
  {
    ...
    if (rendermode == UNDISTORT)
    {
      GLfloat fa_texcoords[8] = {
          (float)v2_offset[0], (float)v2_offset[1],
          (float)v2_offset[0], (float)v2_offset[1] + (float)frametexture_height,
          (float)v2_offset[0] + (float)frametexture_width, (float)v2_offset[1] + (float)frametexture_height,
          (float)v2_offset[0] + (float)frametexture_width, (float)v2_offset[1]};
