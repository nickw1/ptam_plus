...
namespace ptam {
  ...
  namespace gl {
    ...
    template<> struct data < CVD::Rgb<unsigned char> > {
      static const int format = GL_RGB;
      static const int type = GL_UNSIGNED_BYTE;
    };

    template<> struct data < CVD::Rgb<signed char> > {
      static const int format = GL_RGB;
      static const int type = GL_BYTE;
    };

    template<> struct data < CVD::Rgb<unsigned  short> > {
      static const int format = GL_RGB;
      static const int type = GL_UNSIGNED_SHORT;
    };

    template<> struct data < CVD::Rgb<short> > {
      static const int format = GL_RGB;
      static const int type = GL_SHORT;
    };

    template<> struct data < CVD::Rgb<float> > {
      static const int format = GL_RGB;
      static const int type = GL_FLOAT;
    };
    ...
    template<> struct data < CVD::Rgba<unsigned char> > {
      static const int format = GL_RGBA;
      static const int type = GL_UNSIGNED_BYTE;
    };

    template<> struct data < CVD::Rgba<signed char> > {
      static const int format = GL_RGBA;
      static const int type = GL_BYTE;
    };

    template<> struct data < CVD::Rgba<unsigned  short> > {
      static const int format = GL_RGBA;
      static const int type = GL_UNSIGNED_SHORT;
    };

    template<> struct data < CVD::Rgba<short> > {
      static const int format = GL_RGBA;
      static const int type = GL_SHORT;
    };

    template<> struct data < CVD::Rgba<float> > {
      static const int format = GL_RGBA;
      static const int type = GL_FLOAT;
    };

    //La<*> types
    template<> struct data < CVD::La<unsigned char> > {
      static const int format = GL_LUMINANCE_ALPHA;
      static const int type = GL_UNSIGNED_BYTE;
    };

    template<> struct data < CVD::La<signed char> > {
      static const int format = GL_LUMINANCE_ALPHA;
      static const int type = GL_BYTE;
    };

    template<> struct data < CVD::La<unsigned  short> > {
      static const int format = GL_LUMINANCE_ALPHA;
      static const int type = GL_UNSIGNED_SHORT;
    };

    template<> struct data < CVD::La<short> > {
      static const int format = GL_LUMINANCE_ALPHA;
      static const int type = GL_SHORT;
    };

    template<> struct data < CVD::La<float> > {
      static const int format = GL_LUMINANCE_ALPHA;
      static const int type = GL_FLOAT;
    };
