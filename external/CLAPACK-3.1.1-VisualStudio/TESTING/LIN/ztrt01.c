...
static integer c__1 = 1;
 /* Subroutine */ int ztrt01_(char *uplo, char *diag, integer *n,  	doublecomplex *a, integer *lda, doublecomplex *ainv, integer *ldainv,  	doublereal *rcond, doublereal *rwork, doublereal *resid  	)
{
