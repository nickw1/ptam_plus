	...
	rwork, integer *nout)
{
    ...
    static real z__[3];
    static integer ia, in, kl, ku, ix, lda;
    static real cond;
    static integer mode;
    static real dmax__;
    ...
    extern /* Subroutine */ int sptt01_(integer *, real *, real *, real *, 
	    real *, real *, real *), sptt02_(integer *, integer *, real *,  	    real *, real *, integer *, real *, integer *, real *), scopy_( 	    integer *, real *, integer *, real *, integer *), sptt05_(integer  	    *, integer *, real *, real *, real *, integer *, real *, integer * 	    , real *, integer *, real *, real *, real *);     static logical zerot;     extern /* Subroutine */ int slatb4_(char *, integer *, integer *, integer  	    *, char *, integer *, integer *, real *, integer *, real *, char * 	    ), alaerh_(char *, char *, integer *, 
