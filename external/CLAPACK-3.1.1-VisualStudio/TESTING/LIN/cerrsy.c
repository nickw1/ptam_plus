...
/* Subroutine */ int cerrsy_(char *path, integer *nunit)
{
    ...
    static real anrm, rcond;
    extern /* Subroutine */ int csytf2_(char *, integer *, complex *, integer 
	    *, integer *, integer *), alaesm_(char *, logical *, 
	    integer *);
    extern logical lsamen_(integer *, char *, char *);
    extern /* Subroutine */ int chkxer_(char *, integer *, integer *, logical 
	    *, logical *), cspcon_(char *, integer *, complex *,  	    integer *, real *, real *, complex *, integer *), csycon_( 	    char *, integer *, complex *, integer *, integer *, real *, real * 	    , complex *, integer *), csprfs_(char *, integer *,  	    integer *, complex *, complex *, integer *, complex *, integer *,  	    complex *, integer *, real *, real *, complex *, real *, integer * 	    ), csptrf_(char *, integer *, complex *, integer *, 
