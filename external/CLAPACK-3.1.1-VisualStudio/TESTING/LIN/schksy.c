	...
	iwork, integer *nout)
{
    ...
    extern /* Subroutine */ int spot03_(char *, integer *, real *, integer *, 
	    ...
	    real *, real *);     static integer lwork;     static logical zerot;     extern /* Subroutine */ int ssyt01_(char *, integer *, real *, integer *,  	    real *, integer *, integer *, real *, integer *, real *, real *);     static char xtype[1];     extern /* Subroutine */ int slatb4_(char *, integer *, integer *, integer  	    *, char *, integer *, integer *, real *, integer *, real *, char * 	    ), alaerh_(char *, char *, integer *, 
