...
/* Subroutine */ int cerrge_(char *path, integer *nunit)
{
    ...
    static integer ip[4], info;
    static real anrm, ccond, rcond;     extern /* Subroutine */ int cgbtf2_(integer *, integer *, integer *,  	    integer *, complex *, integer *, integer *, integer *), cgetf2_( 	    integer *, integer *, complex *, integer *, integer *, integer *), 	     cgbcon_(char *, integer *, integer *, integer *, complex *,  	    integer *, integer *, real *, real *, complex *, real *, integer * 	    ), cgecon_(char *, integer *, complex *, integer *, real *
    ...
    extern /* Subroutine */ int cgbtrs_(char *, integer *, integer *, integer 
	    *, integer *, complex *, integer *, integer *, complex *, integer 
	    *, integer *), chkxer_(char *, integer *, integer *,	    logical *, logical *), cgetrs_(char *, integer *, integer 
