...
static integer c_n1 = -1;
 /* Subroutine */ int clattr_(integer *imat, char *uplo, char *trans, char * 	diag, integer *iseed, integer *n, complex *a, integer *lda, complex * 	b, complex *work, real *rwork, integer *info  	)
{
    ...
    extern /* Subroutine */ int ccopy_(integer *, complex *, integer *, 
	    ...
	    integer *);     static logical upper;     extern /* Subroutine */ int clatb4_(char *, integer *, integer *, integer  	    *, char *, integer *, integer *, real *, integer *, real *, char * 	    ), slabad_(real *, real *);
