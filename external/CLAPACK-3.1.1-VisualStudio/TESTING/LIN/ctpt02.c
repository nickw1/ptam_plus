...
static complex c_b12 = {-1.f,0.f};
 /* Subroutine */ int ctpt02_(char *uplo, char *trans, char *diag, integer *n,  	integer *nrhs, complex *ap, complex *x, integer *ldx, complex *b,  	integer *ldb, complex *work, real *rwork, real *resid  	)
{
