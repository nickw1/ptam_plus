	...
	integer *iwork, integer *nout)
{
    ...
    static real z__[3];
    static integer k1, in, kl, ku, ix, nt, lda;
    static char fact[1];
    static real cond;
    ...
    extern /* Subroutine */ int ccopy_(integer *, complex *, integer *, 
	    ...
	    complex *, complex *, complex *, integer *, integer *);     static char trans[1];     static integer izero, nerrs;     static logical zerot;     extern /* Subroutine */ int clatb4_(char *, integer *, integer *, integer  	    *, char *, integer *, integer *, real *, integer *, real *, char * 	    ), aladhd_(integer *, char *), 
