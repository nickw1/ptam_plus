	...
	integer *nout)
{
    ...
    static real z__[3];
    static integer k1, ia, in, kl, ku, ix, nt, lda;
    static char fact[1];
    static real cond;
    static integer mode;
    static real dmax__;
    ...
    static integer nrun, ifact, nfail, iseed[4];
    static real rcond;
    ...
    extern /* Subroutine */ int sptt01_(integer *, real *, real *, real *, 
	    ...
	    integer *, real *, integer *, real *, integer *), sptt05_(integer  	    *, integer *, real *, real *, real *, integer *, real *, integer * 	    , real *, integer *, real *, real *, real *);     static logical zerot;     extern /* Subroutine */ int sptsv_(integer *, integer *, real *, real *,  	    real *, integer *, integer *), slatb4_(char *, integer *, integer  	    *, integer *, char *, integer *, integer *, real *, integer *,  	    real *, char *), aladhd_(integer *, char * 	    ), alaerh_(char *, char *, integer *, integer *, char *, 
