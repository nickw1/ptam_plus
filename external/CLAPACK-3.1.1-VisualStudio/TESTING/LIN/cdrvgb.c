	...
	integer *iwork, integer *nout)
{
    ...
    static real roldo;
    static char trans[1];     static integer izero, nerrs;     static logical zerot;     static char xtype[1];     extern /* Subroutine */ int clatb4_(char *, integer *, integer *, integer  	    *, char *, integer *, integer *, real *, integer *, real *, char * 	    ), aladhd_(integer *, char *);
