	...
	work, real *rwork, integer *iwork, integer *nout)
{
    ...
    static char trans[1];     static integer izero, nerrs;     static real dummy;     static integer lwork;     static logical zerot;     static char xtype[1];     extern /* Subroutine */ int slatb4_(char *, integer *, integer *, integer  	    *, char *, integer *, integer *, real *, integer *, real *, char * 	    ), alaerh_(char *, char *, integer *, 
