...
static integer c__1 = 1;
 /* Subroutine */ int cppt05_(char *uplo, integer *n, integer *nrhs, complex * 	ap, complex *b, integer *ldb, complex *x, integer *ldx, complex *xact, 	 integer *ldxact, real *ferr, real *berr, real *reslts  	)
{
