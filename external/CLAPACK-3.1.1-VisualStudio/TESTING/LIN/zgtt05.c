	...
	if (notran) {
		...
		for (i__ = 2; i__ <= i__2; ++i__) {
		    ...
		    tmp = (d__1 = b[i__3].r, abs(d__1)) + (d__2 = d_imag(&b[
			    i__ + k * b_dim1]), abs(d__2)) + ((d__3 = dl[i__4] 			    .r, abs(d__3)) + (d__4 = d_imag(&dl[i__ - 1]),  			    abs(d__4))) * ((d__5 = x[i__5].r, abs(d__5)) + ( 			    d__6 = d_imag(&x[i__ - 1 + k * x_dim1]), abs(d__6) 			    )) + ((d__7 = d__[i__6].r, abs(d__7)) + (d__8 = 
...
/* L40: */
		...
		for (i__ = 2; i__ <= i__2; ++i__) {
		    ...
		    i__9 = i__ + 1 + k * x_dim1;
		    tmp = (d__1 = b[i__3].r, abs(d__1)) + (d__2 = d_imag(&b[
			    i__ + k * b_dim1]), abs(d__2)) + ((d__3 = du[i__4] 			    .r, abs(d__3)) + (d__4 = d_imag(&du[i__ - 1]),  			    abs(d__4))) * ((d__5 = x[i__5].r, abs(d__5)) + ( 			    d__6 = d_imag(&x[i__ - 1 + k * x_dim1]), abs(d__6) 			    )) + ((d__7 = d__[i__6].r, abs(d__7)) + (d__8 = 
			    d_imag(&d__[i__]), abs(d__8))) * ((d__9 = x[i__7]
			    .r, abs(d__9)) + (d__10 = d_imag(&x[i__ + k * 
