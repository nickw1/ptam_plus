	...
	xact, complex *work, real *rwork, integer *nout)
{
    ...
    /* Local variables */
    static integer i__, j, k, n, kd, ik, in, nk, lda, ldab;
    static char diag[1];
    ...
    extern /* Subroutine */ int ctbt02_(char *, char *, char *, integer *, 
	    ...
	    integer *, complex *, integer *, real *, real *, real *, complex * 	    , integer *, complex *, integer *, complex *, real *);     extern logical lsame_(char *, char *);     extern /* Subroutine */ int ctbt05_(char *, char *, char *, integer *,  	    integer *, integer *, complex *, integer *, complex *, integer *,  	    complex *, integer *, complex *, integer *, real *, real *, real * 	    ), ctbt06_(real *, real *, char *, char *,
