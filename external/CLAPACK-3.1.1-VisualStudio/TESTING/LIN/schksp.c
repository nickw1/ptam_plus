	...
	real *work, real *rwork, integer *iwork, integer *nout)
{
    ...
    /* Local variables */
    static integer i__, j, k, n, i1, i2, in, kl, ku, nt, lda, npp, ioff, mode,
	     imat, info;
    ...
    extern /* Subroutine */ int sppt02_(char *, integer *, integer *, real *, 
	    ...
	    real *, real *), sppt05_(char *, integer *, integer *,  	    real *, real *, integer *, real *, integer *, real *, integer *,  	    real *, real *, real *), sspt01_(char *, integer *, real * 	    , real *, integer *, real *, integer *, real *, real *);     static logical zerot;     static char xtype[1];     extern /* Subroutine */ int slatb4_(char *, integer *, integer *, integer  	    *, char *, integer *, integer *, real *, integer *, real *, char * 	    ), alaerh_(char *, char *, integer *, 
