...
static doublereal c_b93 = 2.;
 /* Subroutine */ int zlattp_(integer *imat, char *uplo, char *trans, char * 	diag, integer *iseed, integer *n, doublecomplex *ap, doublecomplex *b, 	 doublecomplex *work, doublereal *rwork, integer *info  	)
{
    ...
    static integer jl, kl, jr, ku, iy, jx;
    static doublereal ulp, sfac;
    static integer mode;
...
/* L360: */
	...
	if (upper) {
		...
		jc = jc - j + 1;
		i__1 = jc;
		d__1 = -(tscal / (doublereal) (*n + 1)) / (doublereal) (*n + 2);
		ap[i__1].r = d__1, ap[i__1].i = 0.;
		i__1 = jc + j - 2;
		ap[i__1].r = 1., ap[i__1].i = 0.;
		i__1 = j - 1;
