...
/* Subroutine */ int serrlq_(char *path, integer *nunit)
{
    ...
    static integer info;     extern /* Subroutine */ int sgelq2_(integer *, integer *, real *, integer  	    *, real *, real *, integer *), sorgl2_(integer *, integer *,  	    integer *, real *, integer *, real *, real *, integer *), sorml2_( 	    char *, char *, integer *, integer *, integer *, real *, integer * 	    , real *, real *, integer *, real *, integer *),  	    alaesm_(char *, logical *, integer *), sgelqf_(integer *,  	    integer *, real *, integer *, real *, real *, integer *, integer * 	    ), chkxer_(char *, integer *, integer *, logical *, logical *), sgelqs_(integer *, integer *, integer *, real *, integer 
