...
static doublereal c_b19 = 1.;  /* Subroutine */ int zppt01_(char *uplo, integer *n, doublecomplex *a,  	doublecomplex *afac, doublereal *rwork, doublereal *resid  	)
{
