	...
	real *s, real *work, real *rwork, integer *iwork, integer *nout)
{
    ...
    /* Local variables */
    static integer i__, k, n, i1, i2, k1, kd, nb, in, kl, iw, ku, nt, lda, 
	    ikd, nkd, ldab;
    static char fact[1];
    ...
    static integer nrun, ifact, nfail, iseed[4], nfact, kdval[4];
    ...
    extern /* Subroutine */ int scopy_(integer *, real *, integer *, real *,  	    integer *), spbsv_(char *, integer *, integer *, integer *, real * 	    , integer *, real *, integer *, integer *), sswap_( 	    integer *, real *, integer *, real *, integer *);     static logical zerot;     static char xtype[1];     extern /* Subroutine */ int slatb4_(char *, integer *, integer *, integer  	    *, char *, integer *, integer *, real *, integer *, real *, char * 	    ), aladhd_(integer *, char *), 
