...
/* Subroutine */ int serrtr_(char *path, integer *nunit)
{
    ...
    /* Local variables */
    static real a[4]	/* was [2][2] */, b[2], w[2], x[2];
    static char c2[2];
    static real r1[2], r2[2];
    static integer iw[2], info;
    static real scale, rcond;
    ...
    extern /* Subroutine */ int chkxer_(char *, integer *, integer *, logical 
	    *, logical *), slatbs_(char *, char *, char *, char *, 
	    ...
	    , char *, integer *, integer *, real *, integer *, real *, real *, 	     integer *, integer *), stbrfs_(char *,  	    char *, char *, integer *, integer *, integer *, real *, integer * 	    , real *, integer *, real *, integer *, real *, real *, real *,  	    integer *, integer *), slatps_(char *,  	    char *, char *, char *, integer *, real *, real *, real *, real *, 	     integer *), stpcon_(char *, char  	    *, char *, integer *, real *, real *, real *, integer *, integer * 	    ), slatrs_(char *, char *, char *, char *,
      	     integer *, real *, integer *, real *, real *, real *, integer *), strcon_(char *, char *, char *,  	    integer *, real *, integer *, real *, real *, integer *, integer * 	    ), stbtrs_(char *, char *, char *, 
