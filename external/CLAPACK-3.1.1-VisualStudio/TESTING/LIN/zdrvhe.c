	...
	doublecomplex *work, doublereal *rwork, integer *iwork, integer *nout)
{
    ...
    extern /* Subroutine */ int zhesv_(char *, integer *, integer *, 
	    doublecomplex *, integer *, integer *, doublecomplex *, integer *, 	     doublecomplex *, integer *, integer *), zpot02_(char *,  	    integer *, integer *, doublecomplex *, integer *, doublecomplex *, 	     integer *, doublecomplex *, integer *, doublereal *, doublereal * 	    ), zpot05_(char *, integer *, integer *, doublecomplex *, 
