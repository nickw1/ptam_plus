...
/* Subroutine */ int schkeq_(real *thresh, integer *nout)
{
    ...
    /* Local variables */
    static real a[25]	/* was [5][5] */, c__[5];
    static integer i__, j, m, n;
    static real r__[5], ab[65]	/* was [13][5] */, ap[15];
    static integer kl;
    static logical ok;
    static integer ku;
    ...
    static integer info;
    static char path[3];
    static real norm, rpow[11], ccond, rcond, rcmin, rcmax, ratio;
...
/* Computing MAX */ 		r__2 = reslts[2], r__3 = (r__1 = (norm - pow[n * 2]) / pow[n * 			 2], dabs(r__1)); 		reslts[2] = dmax(r__2,r__3); 		i__1 = n; 		for (i__ = 1; i__ <= i__1; ++i__) { /* Computing MAX */ 		    r__2 = reslts[2], r__3 = (r__1 = (r__[i__ - 1] - rpow[i__] 			    ) / rpow[i__], dabs(r__1));
		    reslts[2] = dmax(r__2,r__3);
/* L280: */
		}
	    }
...
/* Computing MAX */ 		r__2 = reslts[3], r__3 = (r__1 = (norm - pow[n * 2]) / pow[n * 			 2], dabs(r__1)); 		reslts[3] = dmax(r__2,r__3); 		i__1 = n; 		for (i__ = 1; i__ <= i__1; ++i__) { /* Computing MAX */ 		    r__2 = reslts[3], r__3 = (r__1 = (r__[i__ - 1] - rpow[i__] 			    ) / rpow[i__], dabs(r__1));
		    reslts[3] = dmax(r__2,r__3);
/* L320: */
		}
	    }
