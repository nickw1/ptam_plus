	...
	iwork, integer *nout)
{
    ...
    /* Local variables */
    static integer i__, k, n, nb, in, kl, ku, lda, inb, ioff, mode, imat, 
	    info;
    ...
    extern /* Subroutine */ int spot03_(char *, integer *, real *, integer *,  	    real *, integer *, real *, integer *, real *, real *, real *), spot05_(char *, integer *, integer *, real *, integer *,  	    real *, integer *, real *, integer *, real *, integer *, real *,  	    real *, real *);     static logical zerot;     static char xtype[1];     extern /* Subroutine */ int slatb4_(char *, integer *, integer *, integer  	    *, char *, integer *, integer *, real *, integer *, real *, char * 	    ), alaerh_(char *, char *, integer *, 
