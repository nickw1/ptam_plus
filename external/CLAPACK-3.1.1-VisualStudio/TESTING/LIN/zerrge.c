...
/* Subroutine */ int zerrge_(char *path, integer *nunit)
{
    ...
    static doublereal anrm, ccond, rcond;
    ...
    extern /* Subroutine */ int zgbcon_(char *, integer *, integer *, integer 
	    *, doublecomplex *, integer *, integer *, doublereal *, 
	    ...
	    chkxer_(char *, integer *, integer *, logical *, logical *), zgecon_(char *, integer *, doublecomplex *, integer *,	    doublereal *, doublereal *, doublecomplex *, doublereal *,	    integer *), zgbequ_(integer *, integer *, integer *, 
