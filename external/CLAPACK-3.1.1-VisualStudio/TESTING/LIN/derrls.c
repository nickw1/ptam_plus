...
/* Subroutine */ int derrls_(char *path, integer *nunit)
{
    ...
    extern /* Subroutine */ int dgelss_(integer *, integer *, integer *, 
	    ...
	    chkxer_(char *, integer *, integer *, logical *, logical *), dgelsx_(integer *, integer *, integer *, doublereal *,	    integer *, doublereal *, integer *, integer *, doublereal *,	    integer *, doublereal *, integer *), dgelsy_(integer *, integer *,
