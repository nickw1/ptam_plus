...
/* Subroutine */ int derrlq_(char *path, integer *nunit)
{
    ...
    static doublereal w[2], x[2], af[4]	/* was [2][2] */;
    static integer info;
    extern /* Subroutine */ int dgelq2_(integer *, integer *, doublereal *, 
	    ...
	    *, doublereal *, integer *, integer *), dgelqs_(integer *, 
	    ...
	    chkxer_(char *, integer *, integer *, logical *, logical *), dorglq_(integer *, integer *, integer *, doublereal *,	    integer *, doublereal *, doublereal *, integer *, integer *),	    dormlq_(char *, char *, integer *, integer *, integer *, 
