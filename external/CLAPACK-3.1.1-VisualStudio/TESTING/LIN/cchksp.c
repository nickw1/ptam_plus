	...
	*nout)
{
    ...
    extern /* Subroutine */ int ccopy_(integer *, complex *, integer *, 
	    ...
	    complex *, integer *, real *, real *, real *);     static integer iuplo, izero, nerrs;     static logical zerot;     static char xtype[1];     extern /* Subroutine */ int clatb4_(char *, integer *, integer *, integer  	    *, char *, integer *, integer *, real *, integer *, real *, char * 	    ), alaerh_(char *, char *, integer *, 
