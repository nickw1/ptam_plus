...
/*     Test 2:  Compute the maximum of BERR / ( NZ*EPS + (*) ), where   
	...
	if (*n == 1) {
		...
		i__7 = i__ - 1 + k * x_dim1;
		i__8 = i__;
		i__9 = i__ + 1 + k * x_dim1; 		tmp = (r__1 = b[i__5].r, dabs(r__1)) + (r__2 = r_imag(&b[i__  			+ k * b_dim1]), dabs(r__2)) + ((r__3 = e[i__6].r,  			dabs(r__3)) + (r__4 = r_imag(&e[i__ - 1]), dabs(r__4)) 			) * ((r__5 = x[i__7].r, dabs(r__5)) + (r__6 = r_imag(&
