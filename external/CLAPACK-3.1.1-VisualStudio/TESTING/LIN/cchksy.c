	...
	real *rwork, integer *iwork, integer *nout)
{
    ...
    /* Local variables */
    static integer i__, j, k, n, i1, i2, nb, in, kl, ku, nt, lda, inb, ioff, 
	    mode, imat, info;
    ...
    extern /* Subroutine */ int csyt01_(char *, integer *, complex *, integer 
	    *, complex *, integer *, integer *, complex *, integer *, real *, 
	    ...
	    complex *, integer *, complex *, integer *, real *, real *, real * );     static integer iuplo, izero, nerrs, lwork;     static logical zerot;     static char xtype[1];     extern /* Subroutine */ int clatb4_(char *, integer *, integer *, integer  	    *, char *, integer *, integer *, real *, integer *, real *, char * 	    ), alaerh_(char *, char *, integer *, 
    ...
    extern doublereal clansy_(char *, char *, integer *, complex *, integer *,
	     real *);
    static logical trfcon;     extern /* Subroutine */ int csycon_(char *, integer *, complex *, integer  	    *, integer *, real *, real *, complex *, integer *),  	    clatsy_(char *, integer *, complex *, integer *, integer *), xlaenv_(integer *, integer *), cerrsy_(char *, integer *), csyrfs_(char *, integer *, integer *, complex *,  	    integer *, complex *, integer *, integer *, complex *, integer *,  	    complex *, integer *, real *, real *, complex *, real *, integer * 	    ), csytrf_(char *, integer *, complex *, integer *, 
