...
static doublereal c_b6 = 1.;
 /* Subroutine */ int dsyt01_(char *uplo, integer *n, doublereal *a, integer * 	lda, doublereal *afac, integer *ldafac, integer *ipiv, doublereal * 	c__, integer *ldc, doublereal *rwork, doublereal *resid  	)
{
