...
/* Main program */ int MAIN__(void)
{
    ...
    /* Local variables */
    static doublereal a[153384]	/* was [21912][7] */, b[8448]	/* was [2112][
	    4] */;
    static integer i__, j, k;
    static doublereal s[264];
    static char c1[1], c2[2];
    static doublereal s1, s2;
    static integer ic, la, nb, nm, nn, vers_patch__, vers_major__, 
	    vers_minor__, lda, nnb;
    static doublereal eps;
    static integer nns, nnb2;
    static char path[3];
    static integer mval[12], nval[12], nrhs;
    static doublereal work[23496]	/* was [132][178] */;
    static integer lafac;
    static logical fatal;
    static char aline[72];
    extern logical lsame_(char *, char *);
    static integer nbval[12], nmats, nsval[12], nxval[12], iwork[3300];
    static doublereal rwork[692];
    ...
    static cilist io___108 = { 0, 6, 0, fmt_9988, 0 };
    ...
    static cilist io___120 = { 0, 6, 0, fmt_9990, 0 };
    static cilist io___122 = { 0, 6, 0, fmt_9998, 0 };
    static cilist io___123 = { 0, 6, 0, fmt_9997, 0 };
