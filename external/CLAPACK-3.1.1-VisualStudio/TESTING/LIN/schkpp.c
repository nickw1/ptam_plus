	...
	real *work, real *rwork, integer *iwork, integer *nout)
{
    ...
    /* Local variables */
    static integer i__, k, n, in, kl, ku, lda, npp, ioff, mode, imat, info;
    ...
    extern /* Subroutine */ int sppt02_(char *, integer *, integer *, real *, 
	    ...
	    char *, integer *, real *, real *, real *, integer *, real *,  	    real *, real *), sppt05_(char *, integer *, integer *,  	    real *, real *, integer *, real *, integer *, real *, integer *,  	    real *, real *, real *);     static logical zerot;     static char xtype[1];     extern /* Subroutine */ int slatb4_(char *, integer *, integer *, integer  	    *, char *, integer *, integer *, real *, integer *, real *, char * 	    ), alaerh_(char *, char *, integer *, 
