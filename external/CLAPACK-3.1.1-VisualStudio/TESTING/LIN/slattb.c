...
static integer c__1 = 1; static real c_b36 = 2.f; static real c_b47 = 1.f; static integer c_n1 = -1;  /* Subroutine */ int slattb_(integer *imat, char *uplo, char *trans, char * 	diag, integer *iseed, integer *n, integer *kd, real *ab, integer * 	ldab, real *b, real *work, integer *info  	)
{
    ...
    /* Local variables */
    static integer i__, j, kl, ku, iy;
    static real ulp, sfac;
    static integer ioff, mode, lenj;
    static char path[3], dist[1];
    static real unfl, rexp;
    static char type__[1];
    static real texp, star1, plus1, plus2, bscal;
    extern logical lsame_(char *, char *);
    extern /* Subroutine */ int sscal_(integer *, real *, real *, integer *);
    static real tscal, anorm, bnorm, tleft;     static logical upper;     extern /* Subroutine */ int scopy_(integer *, real *, integer *, real *,  	    integer *), sswap_(integer *, real *, integer *, real *, integer * );     static real tnorm;     extern /* Subroutine */ int slatb4_(char *, integer *, integer *, integer  	    *, char *, integer *, integer *, real *, integer *, real *, char * 	    ), slabad_(real *, real *);
