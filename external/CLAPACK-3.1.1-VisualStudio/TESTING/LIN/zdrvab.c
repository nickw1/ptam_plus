	...
	swork, integer *iwork, integer *nout)
{
    ...
    /* Local variables */
    static integer i__, m, n, im, kl, ku, lda, ioff, mode, kase, imat, info;
    static char path[3], dist[1];
    static integer irhs, iter, nrhs;
    static char type__[1];
    static integer nrun;
    extern /* Subroutine */ int alahd_(integer *, char *);
    static integer nfail, iseed[4], nimat;
