	...
	xact, complex *work, real *rwork, integer *iwork, integer *nout)
{
    ...
    /* Local variables */
    static integer i__, j, k, n, i1, i2, k1, nb, in, kl, ku, nt, lda, npp;
    static char fact[1];
    ...
    extern /* Subroutine */ int cspsv_(char *, integer *, integer *, complex * 	    , integer *, complex *, integer *, integer *);     static logical zerot;     static char xtype[1];     extern /* Subroutine */ int clatb4_(char *, integer *, integer *, integer  	    *, char *, integer *, integer *, real *, integer *, real *, char * 	    ), aladhd_(integer *, char *), 
