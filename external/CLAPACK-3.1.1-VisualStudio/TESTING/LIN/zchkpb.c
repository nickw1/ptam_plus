	...
	doublereal *rwork, integer *nout)
{
    ...
    static integer nimat;     static doublereal anorm;     extern /* Subroutine */ int zget04_(integer *, integer *, doublecomplex *, 	     integer *, doublecomplex *, integer *, doublereal *, doublereal * 	    ), zpbt01_(char *, integer *, integer *, doublecomplex *, integer 
