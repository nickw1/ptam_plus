	...
	iwork, integer *nout)
{
    ...
    /* Local variables */
    static integer i__, k, n, i1, i2, kd, nb, in, kl, iw, ku, lda, ikd, inb, 
	    nkd, ldab, ioff, mode, koff, imat, info;
    static char path[3], dist[1];
    static integer irhs, nrhs;
    static char uplo[1], type__[1];
    static integer nrun;
    extern /* Subroutine */ int alahd_(integer *, char *);
    static integer nfail, iseed[4], kdval[4];
    static real rcond;
    ...
    static integer iuplo, izero, nerrs;     extern /* Subroutine */ int scopy_(integer *, real *, integer *, real *,  	    integer *), sswap_(integer *, real *, integer *, real *, integer * );     static logical zerot;     static char xtype[1];     extern /* Subroutine */ int slatb4_(char *, integer *, integer *, integer  	    *, char *, integer *, integer *, real *, integer *, real *, char * 	    ), alaerh_(char *, char *, integer *, 
