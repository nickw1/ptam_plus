	...
	*nout)
{
    ...
    /* Local variables */
    static integer i__, j, k, n, i1, i2, k1, nb, in, kl, ku, nt, lda, ldb, 
	    ikl, nkl, iku, nku;
    static char fact[1];
    ...
    static integer nrun, ldafb, ifact, nfail, iseed[4], nfact;
    ...
    extern /* Subroutine */ int sgbsv_(integer *, integer *, integer *, 
	    integer *, real *, integer *, integer *, real *, integer *,  	    integer *);     static char trans[1];     static integer izero, nerrs;     static logical zerot;     static char xtype[1];     extern /* Subroutine */ int slatb4_(char *, integer *, integer *, integer  	    *, char *, integer *, integer *, real *, integer *, real *, char * 	    ), aladhd_(integer *, char *), 
...
/* Writing concatenation */
				    ...
				    s_cat(ch__1, a__1, i__11, &c__2, (ftnlen)2);
