...
#include "f2c.h"
 /* Subroutine */ int dtbt06_(doublereal *rcond, doublereal *rcondc, char * 	uplo, char *diag, integer *n, integer *kd, doublereal *ab, integer * 	ldab, doublereal *work, doublereal *rat  	)
{
