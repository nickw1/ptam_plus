...
/* Subroutine */ int cerrtr_(char *path, integer *nunit)
{
    ...
    /* Local variables */
    static complex a[4]	/* was [2][2] */, b[2], w[2], x[2];
    static char c2[2];
    static real r1[2], r2[2], rw[2];
    static integer info;
    ...
    extern /* Subroutine */ int ctrti2_(char *, char *, integer *, complex *, 
	    ...
	    , char *, char *, integer *, integer *, complex *, integer *,  	    real *, complex *, real *, integer *);     extern logical lsamen_(integer *, char *, char *);     extern /* Subroutine */ int ctbrfs_(char *, char *, char *, integer *,  	    integer *, integer *, complex *, integer *, complex *, integer *,  	    complex *, integer *, real *, real *, complex *, real *, integer * 	    ), chkxer_(char *, integer *, integer *,	    logical *, logical *), clatps_(char *, char *, char *,  	    char *, integer *, complex *, complex *, real *, real *, integer * 	    ), ctpcon_(char *, char *, char *,
