	...
	integer *nout)
{
    ...
    extern /* Subroutine */ int sqrt01_(integer *, integer *, real *, real *, 
	    ...
	    real *), sqrt02_(integer *, integer *, integer *, real *, real *,  	    real *, real *, integer *, real *, real *, integer *, real *,  	    real *), sqrt03_(integer *, integer *, integer *, real *, real *,  	    real *, real *, integer *, real *, real *, integer *, real *,  	    real *);     static integer lwork;     extern /* Subroutine */ int slatb4_(char *, integer *, integer *, integer  	    *, char *, integer *, integer *, real *, integer *, real *, char * 	    ), alaerh_(char *, char *, integer *, 
