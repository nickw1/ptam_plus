	...
	x, complex *xact, real *s, complex *work, real *rwork, integer *nout)
{
    ...
    extern /* Subroutine */ int cswap_(integer *, complex *, integer *, 
	    complex *, integer *);     static integer iuplo, izero, nerrs;     static logical zerot;     static char xtype[1];     extern /* Subroutine */ int clatb4_(char *, integer *, integer *, integer  	    *, char *, integer *, integer *, real *, integer *, real *, char * 	    ), aladhd_(integer *, char *);
