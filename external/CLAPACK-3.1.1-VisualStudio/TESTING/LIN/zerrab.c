...
/* Subroutine */ int zerrab_(integer *nunit)
{
    ...
    /* Local variables */
    static doublecomplex a[16]	/* was [4][4] */, b[4], c__[4];
    static integer i__, j;
    static doublecomplex r__[4], w[8], x[4], r1[4], r2[4], af[16]	/* 
	    was [4][4] */;
    static integer ip[4], info, iter;
    static doublecomplex work[1];
    static complex swork[1];
