...
/* Table of constant values */  static integer c__1 = 1; static real c_b10 = -1.f;  /* Subroutine */ int stpt02_(char *uplo, char *trans, char *diag, integer *n,  	integer *nrhs, real *ap, real *x, integer *ldx, real *b, integer *ldb, 	 real *work, real *resid  	)
{
