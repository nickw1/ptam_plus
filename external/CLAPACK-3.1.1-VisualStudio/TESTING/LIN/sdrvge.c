	...
	real *s, real *work, real *rwork, integer *iwork, integer *nout)
{
    ...
    /* Local variables */
    static integer i__, k, n, k1, nb, in, kl, ku, nt, lda;
    static char fact[1];
    ...
    static integer nrun, ifact, nfail, iseed[4], nfact;
    ...
    extern /* Subroutine */ int sget07_(char *, integer *, integer *, real *, 
	    ...
	    , real *, real *, real *);
    static char trans[1];
    static integer izero, nerrs;     extern /* Subroutine */ int sgesv_(integer *, integer *, real *, integer * 	    , integer *, real *, integer *, integer *);     static integer lwork;     static logical zerot;     static char xtype[1];     extern /* Subroutine */ int slatb4_(char *, integer *, integer *, integer  	    *, char *, integer *, integer *, real *, integer *, real *, char * 	    ), aladhd_(integer *, char *), 
    ...
    extern /* Subroutine */ int sgetrf_(integer *, integer *, real *, integer 
	    ...
	    *, integer *, real *, integer *, real *, integer *), 
	    ...
	    integer *, integer *, integer *, real *, integer *, real *,  	    integer *, real *, integer *, integer *, integer *);     extern doublereal slantr_(char *, char *, char *, integer *, integer *,  	    real *, integer *, real *);     extern /* Subroutine */ int slaset_(char *, integer *, integer *, real *,  	    real *, real *, integer *), slatms_(integer *, integer *,  	    char *, integer *, char *, real *, integer *, real *, real *,  	    integer *, integer *, char *, real *, integer *, real *, integer * 	    ), xlaenv_(integer *, integer *);
