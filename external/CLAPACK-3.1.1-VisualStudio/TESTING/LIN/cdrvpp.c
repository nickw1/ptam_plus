	...
	x, complex *xact, real *s, complex *work, real *rwork, integer *nout)
{
    ...
    /* Local variables */
    static integer i__, k, n, k1, in, kl, ku, nt, lda, npp;
    static char fact[1];
    ...
    extern /* Subroutine */ int cppsv_(char *, integer *, integer *, complex * 	    , complex *, integer *, integer *);     static logical zerot;     static char xtype[1];     extern /* Subroutine */ int clatb4_(char *, integer *, integer *, integer  	    *, char *, integer *, integer *, real *, integer *, real *, char * 	    ), aladhd_(integer *, char *), 
