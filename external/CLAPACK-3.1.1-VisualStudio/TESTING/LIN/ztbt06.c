...
#include "f2c.h"
 /* Subroutine */ int ztbt06_(doublereal *rcond, doublereal *rcondc, char * 	uplo, char *diag, integer *n, integer *kd, doublecomplex *ab, integer  	*ldab, doublereal *rwork, doublereal *rat  	)
{
    ...
    /* Local variables */
    static doublereal eps, rmin, rmax, anorm;
