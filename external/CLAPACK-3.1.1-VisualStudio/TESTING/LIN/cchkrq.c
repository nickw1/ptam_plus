	...
	real *rwork, integer *iwork, integer *nout)
{
    ...
    static real anorm;
    extern /* Subroutine */ int crqt03_(integer *, integer *, integer *,  	    complex *, complex *, complex *, complex *, integer *, complex *,  	    complex *, integer *, real *, real *);     static integer minmn, nerrs, lwork;     extern /* Subroutine */ int clatb4_(char *, integer *, integer *, integer  	    *, char *, integer *, integer *, real *, integer *, real *, char * 	    ), alaerh_(char *, char *, integer *, 
