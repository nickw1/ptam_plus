	...
	real *reslts)
{
    ...
    /* Local variables */
    static integer i__, j, k, nz;
    static real eps, tmp, diff, axbi;
    static integer imax;
...
/*     Test 2:  Compute the maximum of BERR / ( NZ*EPS + (*) ), where   
	...
	if (notran) {
		...
		for (i__ = 2; i__ <= i__2; ++i__) {
		    ...
		    i__7 = i__ + k * x_dim1;
		    i__8 = i__;
		    i__9 = i__ + 1 + k * x_dim1; 		    tmp = (r__1 = b[i__3].r, dabs(r__1)) + (r__2 = r_imag(&b[ 			    i__ + k * b_dim1]), dabs(r__2)) + ((r__3 = dl[ 			    i__4].r, dabs(r__3)) + (r__4 = r_imag(&dl[i__ - 1] 			    ), dabs(r__4))) * ((r__5 = x[i__5].r, dabs(r__5)) 
...
/* L40: */
		...
		tmp = (r__1 = b[i__2].r, dabs(r__1)) + (r__2 = r_imag(&b[*n + 
			...
			r__3)) + (r__4 = r_imag(&dl[*n - 1]), dabs(r__4))) * ( 			(r__5 = x[i__4].r, dabs(r__5)) + (r__6 = r_imag(&x[*n  			- 1 + k * x_dim1]), dabs(r__6))) + ((r__7 = d__[i__5] 			.r, dabs(r__7)) + (r__8 = r_imag(&d__[*n]), dabs(r__8) 			)) * ((r__9 = x[i__6].r, dabs(r__9)) + (r__10 = 
		...
		for (i__ = 2; i__ <= i__2; ++i__) {
		    ...
		    i__7 = i__ + k * x_dim1;
		    i__8 = i__;
		    i__9 = i__ + 1 + k * x_dim1; 		    tmp = (r__1 = b[i__3].r, dabs(r__1)) + (r__2 = r_imag(&b[ 			    i__ + k * b_dim1]), dabs(r__2)) + ((r__3 = du[ 			    i__4].r, dabs(r__3)) + (r__4 = r_imag(&du[i__ - 1] 			    ), dabs(r__4))) * ((r__5 = x[i__5].r, dabs(r__5)) 
			    + (r__6 = r_imag(&x[i__ - 1 + k * x_dim1]), dabs(
			    r__6))) + ((r__7 = d__[i__6].r, dabs(r__7)) + (
			    r__8 = r_imag(&d__[i__]), dabs(r__8))) * ((r__9 = 
			    x[i__7].r, dabs(r__9)) + (r__10 = r_imag(&x[i__ + 
...
/* L50: */
		...
		tmp = (r__1 = b[i__2].r, dabs(r__1)) + (r__2 = r_imag(&b[*n + 
			...
			r__3)) + (r__4 = r_imag(&du[*n - 1]), dabs(r__4))) * ( 			(r__5 = x[i__4].r, dabs(r__5)) + (r__6 = r_imag(&x[*n  			- 1 + k * x_dim1]), dabs(r__6))) + ((r__7 = d__[i__5] 			.r, dabs(r__7)) + (r__8 = r_imag(&d__[*n]), dabs(r__8) 			)) * ((r__9 = x[i__6].r, dabs(r__9)) + (r__10 = 
			r_imag(&x[*n + k * x_dim1]), dabs(r__10)));
		axbi = dmin(axbi,tmp);
	    }
	}
