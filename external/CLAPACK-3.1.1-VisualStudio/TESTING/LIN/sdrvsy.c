	...
	real *rwork, integer *iwork, integer *nout)
{
    ...
    /* Local variables */
    static integer i__, j, k, n, i1, i2, k1, nb, in, kl, ku, nt, lda;
    static char fact[1];
    static integer ioff, mode, imat, info;
    static char path[3], dist[1], uplo[1], type__[1];
    static integer nrun, ifact, nfail, iseed[4], nbmin;
    static real rcond;
    ...
    static logical zerot;     extern /* Subroutine */ int ssyt01_(char *, integer *, real *, integer *,  	    real *, integer *, integer *, real *, integer *, real *, real *);     static char xtype[1];     extern /* Subroutine */ int ssysv_(char *, integer *, integer *, real *,  	    integer *, integer *, real *, integer *, real *, integer *,  	    integer *), slatb4_(char *, integer *, integer *, integer  	    *, char *, integer *, integer *, real *, integer *, real *, char * 	    ), aladhd_(integer *, char *), 
