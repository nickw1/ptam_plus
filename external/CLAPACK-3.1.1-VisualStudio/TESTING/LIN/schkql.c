	...
	integer *nout)
{
    ...
    extern /* Subroutine */ int sqlt01_(integer *, integer *, real *, real *, 
	    ...
	    real *), sqlt02_(integer *, integer *, integer *, real *, real *,  	    real *, real *, integer *, real *, real *, integer *, real *,  	    real *), sqlt03_(integer *, integer *, integer *, real *, real *,  	    real *, real *, integer *, real *, real *, integer *, real *,  	    real *);     static integer nerrs, lwork;     extern /* Subroutine */ int slatb4_(char *, integer *, integer *, integer  	    *, char *, integer *, integer *, real *, integer *, real *, char * 	    ), alaerh_(char *, char *, integer *, 
