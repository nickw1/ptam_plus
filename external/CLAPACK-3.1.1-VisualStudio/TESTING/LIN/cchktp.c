	...
	xact, complex *work, real *rwork, integer *nout)
{
    ...
    /* Local variables */
    static integer i__, k, n, in, lda, lap;
    static char diag[1];
    ...
    extern /* Subroutine */ int clatps_(char *, char *, char *, char *, 
	    ...
	    real *, integer *);     static real ainvnm;     extern /* Subroutine */ int ctpcon_(char *, char *, char *, integer *,  	    complex *, real *, complex *, real *, integer *), cerrtr_(char *, integer *), ctprfs_(char *, char  	    *, char *, integer *, integer *, complex *, complex *, integer *,  	    complex *, integer *, real *, real *, complex *, real *, integer * 	    ), ctptri_(char *, char *, integer *, 
	    complex *, integer *);
