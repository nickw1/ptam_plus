...
/* Subroutine */ int derrql_(char *path, integer *nunit)
{
    ...
    extern /* Subroutine */ int dgeql2_(integer *, integer *, doublereal *, 
	    ...
	    *, doublereal *, integer *, integer *), dgeqls_(integer *, 
	    ...
	    chkxer_(char *, integer *, integer *, logical *, logical *), dorgql_(integer *, integer *, integer *, doublereal *,	    integer *, doublereal *, doublereal *, integer *, integer *),	    dormql_(char *, char *, integer *, integer *, integer *, 
