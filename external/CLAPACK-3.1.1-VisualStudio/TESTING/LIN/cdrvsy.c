	...
	xact, complex *work, real *rwork, integer *iwork, integer *nout)
{
    ...
    extern /* Subroutine */ int csyt01_(char *, integer *, complex *, integer 
	    *, complex *, integer *, integer *, complex *, integer *, real *, 
	    ...
	    real *);
    static integer iuplo, izero, nerrs, lwork;
    static logical zerot;
    extern /* Subroutine */ int csysv_(char *, integer *, integer *, complex * 	    , integer *, integer *, complex *, integer *, complex *, integer * 	    , integer *);     static char xtype[1];     extern /* Subroutine */ int clatb4_(char *, integer *, integer *, integer  	    *, char *, integer *, integer *, real *, integer *, real *, char * 	    ), aladhd_(integer *, char *), 
