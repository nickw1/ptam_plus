	...
	integer *iwork, integer *nout)
{
    ...
    static real z__[3];
    static integer in, kl, ku, ix, lda;
    static real cond;
    ...
    static char trans[1];     static integer izero, nerrs;     extern doublereal sasum_(integer *, real *, integer *);     extern /* Subroutine */ int scopy_(integer *, real *, integer *, real *,  	    integer *);     static logical zerot;     extern /* Subroutine */ int slatb4_(char *, integer *, integer *, integer  	    *, char *, integer *, integer *, real *, integer *, real *, char * 	    ), alaerh_(char *, char *, integer *, 
    ...
    extern /* Subroutine */ int slagtm_(char *, integer *, integer *, real *, 
	    ...
	    integer *);     static logical trfcon;     extern /* Subroutine */ int slacpy_(char *, integer *, integer *, real *,  	    integer *, real *, integer *), sgtcon_(char *, integer *,  	    real *, real *, real *, real *, integer *, real *, real *, real *, 	     integer *, integer *), slatms_(integer *, integer *,  	    char *, integer *, char *, real *, integer *, real *, real *,  	    integer *, integer *, char *, real *, integer *, real *, integer * 	    ), slarnv_(integer *, integer *, integer *
