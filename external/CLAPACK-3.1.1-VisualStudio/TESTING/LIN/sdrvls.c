	...
	copys, real *work, integer *iwork, integer *nout)
{
    ...
    /* Local variables */
    static integer i__, j, k, m, n, nb, im, in, lda, ldb, inb;
    static real eps;
    static integer ins, info;
    static char path[3];
    static integer rank, nrhs, nlvl, nrun;
    extern /* Subroutine */ int alahd_(integer *, char *);
    static integer nfail, iseed[4], crank, irank;
    static real rcond;
    ...
    extern /* Subroutine */ int sgels_(char *, integer *, integer *, integer *
	    ...
	    integer *);     static char trans[1];     static integer nerrs, itype;     extern doublereal sasum_(integer *, real *, integer *);     static integer lwork;     extern doublereal sqrt12_(integer *, integer *, real *, integer *, real *, 	     real *, integer *), sqrt14_(char *, integer *, integer *,  	    integer *, real *, integer *, real *, integer *, real *, integer * 	    ), sqrt17_(char *, integer *, integer *, integer *, 
