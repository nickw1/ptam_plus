	...
	integer *nout)
{
    ...
    extern /* Subroutine */ int srqt01_(integer *, integer *, real *, real *, 
	    ...
	    real *), srqt02_(integer *, integer *, integer *, real *, real *,  	    real *, real *, integer *, real *, real *, integer *, real *,  	    real *), srqt03_(integer *, integer *, integer *, real *, real *,  	    real *, real *, integer *, real *, real *, integer *, real *,  	    real *);     static integer lwork;     extern /* Subroutine */ int slatb4_(char *, integer *, integer *, integer  	    *, char *, integer *, integer *, real *, integer *, real *, char * 	    ), alaerh_(char *, char *, integer *, 
