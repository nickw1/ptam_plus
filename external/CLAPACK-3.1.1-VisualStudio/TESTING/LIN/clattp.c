	...
	work, real *rwork, integer *info)
{
    ...
    static real anorm, bnorm, tleft;
    extern /* Subroutine */ int crotg_(complex *, complex *, real *, complex *
);     static logical upper;     extern /* Subroutine */ int clatb4_(char *, integer *, integer *, integer  	    *, char *, integer *, integer *, real *, integer *, real *, char * 	    ), slabad_(real *, real *);
