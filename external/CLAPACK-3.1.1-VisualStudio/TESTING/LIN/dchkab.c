...
/* Main program */ int MAIN__(void)
{
    ...
    /* Local variables */
    static doublereal a[34848]	/* was [17424][2] */, b[4224]	/* was [2112][
	    2] */;
    static integer i__;
    static doublereal s1, s2;
    static integer nm, vers_patch__, vers_major__, vers_minor__, lda;
    static doublereal eps;
    static integer nns, mval[12], nrhs;
    static real seps;
    static doublereal work[4224];
    static logical fatal;
    static integer nmats, nsval[12], iwork[132];
    static doublereal rwork[132];
    static real swork[19536];
