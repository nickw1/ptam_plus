	...
	integer *nout)
{
    ...
    /* Local variables */
    static integer i__, k, m, n, nb, ik, im, in, kl, nk, ku, nt, nx, lda, inb,
	     mode, imat, info;
    static char path[3];
    ...
    extern /* Subroutine */ int slqt01_(integer *, integer *, real *, real *, 
	    ...
	    real *), slqt02_(integer *, integer *, integer *, real *, real *,  	    real *, real *, integer *, real *, real *, integer *, real *,  	    real *), slqt03_(integer *, integer *, integer *, real *, real *,  	    real *, real *, integer *, real *, real *, integer *, real *,  	    real *);     static integer nerrs, lwork;     extern /* Subroutine */ int slatb4_(char *, integer *, integer *, integer  	    *, char *, integer *, integer *, real *, integer *, real *, char * 	    ), alaerh_(char *, char *, integer *, 
