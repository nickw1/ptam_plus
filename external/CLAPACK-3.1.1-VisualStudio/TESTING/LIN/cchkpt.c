	...
	complex *work, real *rwork, integer *nout)
{
    ...
    extern /* Subroutine */ int ccopy_(integer *, complex *, integer *, 
	    ...
	    *, integer *, complex *, integer *, complex *, integer *, real *, 
	    real *, real *);
    static integer iuplo, izero, nerrs;     extern /* Subroutine */ int scopy_(integer *, real *, integer *, real *,  	    integer *);     static logical zerot;     extern /* Subroutine */ int clatb4_(char *, integer *, integer *, integer  	    *, char *, integer *, integer *, real *, integer *, real *, char * 	    ), alaerh_(char *, char *, integer *, 
