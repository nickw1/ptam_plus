...
/* Subroutine */ int serrql_(char *path, integer *nunit)
{
    ...
    static integer info;     extern /* Subroutine */ int sgeql2_(integer *, integer *, real *, integer  	    *, real *, real *, integer *), sorg2l_(integer *, integer *,  	    integer *, real *, integer *, real *, real *, integer *), sorm2l_( 	    char *, char *, integer *, integer *, integer *, real *, integer * 	    , real *, real *, integer *, real *, integer *),  	    alaesm_(char *, logical *, integer *), sgeqlf_(integer *,  	    integer *, real *, integer *, real *, real *, integer *, integer * 	    ), chkxer_(char *, integer *, integer *, logical *, logical *), sgeqls_(integer *, integer *, integer *, real *, integer 
