	...
	real *rwork, integer *nout)
{
    ...
    extern /* Subroutine */ int scopy_(integer *, real *, integer *, real *,  	    integer *), cptsv_(integer *, integer *, real *, complex *,  	    complex *, integer *, integer *);     static logical zerot;     extern /* Subroutine */ int clatb4_(char *, integer *, integer *, integer  	    *, char *, integer *, integer *, real *, integer *, real *, char * 	    ), aladhd_(integer *, char *), 
