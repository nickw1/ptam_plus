	...
	xact, complex *work, real *rwork, integer *iwork, integer *nout)
{
    ...
    static real anorm;     static integer iuplo, izero, nerrs, lwork;     static logical zerot;     static char xtype[1];     extern /* Subroutine */ int clatb4_(char *, integer *, integer *, integer  	    *, char *, integer *, integer *, real *, integer *, real *, char * 	    ), aladhd_(integer *, char *);
