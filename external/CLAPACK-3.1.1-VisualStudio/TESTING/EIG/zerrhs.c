...
/* Subroutine */ int zerrhs_(char *path, integer *nunit)
{
    ...
    static char c2[2];
    static integer nt;
    static doublecomplex vl[9]	/* was [3][3] */, vr[9]	/* was [3][3] */;
    static doublereal rw[3];
    static integer ihi, ilo;
    static logical sel[3];
    static doublecomplex tau[3];
    static integer info, ifaill[3];
    ...
    extern /* Subroutine */ int zgehrd_(integer *, integer *, integer *, 
	    ...
	    integer *, integer *), chkxer_(char *, integer *, integer *,	    logical *, logical *), zhsein_(char *, char *, char *, 
