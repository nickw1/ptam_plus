	...
	integer *info)
{
    ...
    /* Local variables */
    static integer i__, j, i1, mm;
    static doublereal pl[2];
    static integer mn2, qba, qbb;
    static doublereal ulp, temp1, temp2;
    ...
    static integer nptknt;
    static doublereal result[10];
...
/* Computing MAX */
	i__1 = maxwrk, i__2 = (*nsize + 1) * 9 + *nsize * ilaenv_(&c__1, 
		"DORGQR", " ", nsize, &c__1, nsize, &c_n1, (ftnlen)6, (ftnlen)1);
...
/* Computing MAX */
	...
	i__1 = maxwrk, i__2 = *nsize * 3 * *nsize / 2 + *nsize * *nsize * 
		ilaenv_(&c__1, "DGEBRD", " ", &i__3, &i__4, &c_n1, &c_n1, (ftnlen)6, (ftnlen)1);
	maxwrk = max(i__1,i__2);
...
/*                 Do tests (5) and (6): check Schur form of A and   
			...
			ilabad = FALSE_;
			if (alphai[j] == 0.) {
/* Computing MAX */ 			    d__7 = smlnum, d__8 = (d__2 = alphar[j], abs(d__2) 				    ), d__7 = max(d__7,d__8), d__8 = (d__3 = 
