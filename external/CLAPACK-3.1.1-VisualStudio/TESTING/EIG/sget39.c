	...
	integer *knt)
{
    ...
    /* Local variables */
    static real b[10], d__[20];
    static integer i__, j, k, n;
    static real t[100]	/* was [10][10] */, w, x[20], y[20], vm1[5], vm2[5], 
	    vm3[5], vm4[5], vm5[3], dum[1], eps;
    static integer ivm1, ivm2, ivm3, ivm4, ivm5, ndim, info;
    static real dumm;
    extern doublereal sdot_(integer *, real *, integer *, real *, integer *);
    static real norm, work[10], scale, domin, resid;
