	...
	integer *knt)
{
    ...
    /* Local variables */
    static doublereal b[10], d__[20];
    static integer i__, j, k, n;
    static doublereal t[100]	/* was [10][10] */, w, x[20], y[20], vm1[5], 
	    vm2[5], vm3[5], vm4[5], vm5[3], dum[1], eps;
    static integer ivm1, ivm2, ivm3, ivm4, ivm5, ndim;
    extern doublereal ddot_(integer *, doublereal *, integer *, doublereal *, 
	    integer *);
    static integer info;
    static doublereal dumm, norm, work[10], scale;
    ...
    extern /* Subroutine */ int dlaqtr_(logical *, logical *, integer *, 
	    doublereal *, integer *, doublereal *, doublereal *, doublereal *,
	     doublereal *, doublereal *, integer *);
    static doublereal normtb, smlnum;
