	...
	lwork, integer *iwork, integer *nout, integer *info)
{
    ...
    /* Local variables */
    static integer i__, j, m, n, mq;
    static real dum[1], ulp, cond;
    static integer jcol;
    static char path[3];
    ...
    extern /* Subroutine */ int slacpy_(char *, integer *, integer *, real *, 
	    ...
	    , real *, integer *, real *, integer *, real *, integer *, real *,
	     integer *), sorgbr_(char *, integer *, integer *,  	    integer *, real *, integer *, real *, real *, integer *, integer * 	    ), slatmr_(integer *, integer *, char *, integer *, char *
