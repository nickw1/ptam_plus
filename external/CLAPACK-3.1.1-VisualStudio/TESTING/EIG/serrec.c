...
/* Subroutine */ int serrec_(char *path, integer *nunit)
{
    ...
    /* Local variables */
    static real a[16]	/* was [4][4] */, b[16]	/* was [4][4] */, c__[16]	
	    /* was [4][4] */;
    static integer i__, j, m;
    static real s[4], wi[4];
    static integer nt;
    static real wr[4];
    static logical sel[4];
    static real sep[4];
    static integer info, ifst, ilst;
    static real work[4], scale;
    ...
    extern /* Subroutine */ int chkxer_(char *, integer *, integer *, logical 
	    ...
	    *, real *, integer *, integer *, integer *, real *, integer *), strsna_(char *, char *, logical *, integer *, real *, 
	    ...
	    real *, integer *, real *, integer *, real *, real *, integer *,  	    real *, real *, real *, integer *, integer *, integer *, integer * 	    ), strsyl_(char *, char *, integer *, integer *, 
