...
/* Subroutine */ int dget23_(logical *comp, char *balanc, integer *jtype, 
	...
	doublereal *scale, doublereal *scale1, doublereal *result, doublereal  	*work, integer *lwork, integer *iwork, integer *info  	)
{
    /* Initialized data */
    ...
    static doublereal v;
    static integer jj, ihi, ilo;
    static doublereal dum[1], eps, res[2], tol, ulp, vmx;
    static integer ihi1, ilo1, kmin;
