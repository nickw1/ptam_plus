...
/* Subroutine */ int derrgg_(char *path, integer *nunit)
{
    ...
    static doublereal rs[3], dif, rce[2];
    ...
    extern /* Subroutine */ int dggsvd_(char *, char *, char *, integer *, 
	    ...
	    *, doublereal *, integer *, doublereal *, doublereal *, 
	    ...
	    chkxer_(char *, integer *, integer *, logical *, logical *), dggevx_(char *, char *, char *, char *, integer *,	    doublereal *, integer *, doublereal *, integer *, doublereal *, 
