...
/* Subroutine */ int dchkgl_(integer *nin, integer *nout)
{
    ...
    /* Local variables */
    static doublereal a[400]	/* was [20][20] */, b[400]	/* was [20][
	    20] */;
    static integer i__, j, n;
    static doublereal ain[400]	/* was [20][20] */, bin[400]	/* was [20][
	    20] */;
    static integer ihi, ilo;
    static doublereal eps;
    static integer knt, info, lmax[5];
    ...
    static doublereal lscale[20], rscale[20], lsclin[20], rsclin[20];
