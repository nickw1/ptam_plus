	...
	integer *knt)
{
    ...
    static doublereal q[16]	/* was [4][4] */, t[16]	/* was [4][4] */, t1[
	    16]	/* was [4][4] */;
    static integer ia, ib, ic;
    static doublereal vm[2];
    ...
    extern /* Subroutine */ int dlaexc_(logical *, integer *, doublereal *, 
	    ...
	    *, doublereal *, integer *);
    static doublereal bignum, smlnum, result[2];
...
/* Computing MAX */
				d__1 = abs(t[0]), d__2 = abs(t[4]), d__1 = 
					max(d__1,d__2), d__2 = abs(t[8]),  					d__1 = max(d__1,d__2), d__2 = abs(t[5] 					), d__1 = max(d__1,d__2), d__2 = abs(
