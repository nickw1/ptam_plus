	...
	result, integer *info)
{
    ...
    /* Local variables */
    static integer i__, j, m, n, j1, j2, m2, m3, kd, il, iu;
    static doublereal vl, vu;
    static integer lgn;
    ...
    extern /* Subroutine */ int zhbev_(char *, char *, integer *, integer *, 
	    ...
	    *, doublecomplex *, integer *, doublereal *, doublereal *, 
	    ...
	    integer *, doublereal *, doublecomplex *, integer *, doublereal *,
	     integer *);
    static integer nmats, jsize, iuplo, nerrs, itype, jtype, ntest;
    ...
    static integer liwedc, idumma[1];
