...
/* Subroutine */ int cerrst_(char *path, integer *nunit)
{
    ...
    static char c2[2];
    static integer i1[3], i2[3], i3[3], iw[36], nt;
    static real rw[60];
    ...
    extern /* Subroutine */ int chbevx_(char *, char *, char *, integer *, 
	    ...
	    integer *, real *, integer *, integer *, integer *), chkxer_(char *, integer *, integer *, logical *,	    logical *), chptrd_(char *, integer *, complex *, real *, 
	    ...
	    *, char *, char *, integer *, complex *, real *, real *, integer *
	    ...
	    complex *, integer *, real *, integer *), csteqr_(char *,  	    integer *, real *, real *, complex *, integer *, real *, integer * 	    ), cungtr_(char *, integer *, complex *, integer *, 
