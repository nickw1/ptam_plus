	...
	integer *knt)
{
    ...
    /* Local variables */
    static real a[4]	/* was [2][2] */, b[4]	/* was [2][2] */, x[4]	/* 
	    was [2][2] */, d1, d2, ca;
    static integer ia, ib, na;
    static real wi;
    static integer nw;
    static real wr;
    static integer id1, id2, ica;
    ...
    static integer info;
    static real unfl, smin, scale;
    static integer ismin;
    static real vsmin[4], xnorm;
...
/* Computing MAX   
   Computing MAX */
					    r__8 = (r__1 = ca * a[0] - wr * 
						    d1, dabs(r__1)) + (r__2 = 
						    ca * a[2], dabs(r__2)) + ( 						    r__3 = wi * d1, dabs(r__3) 						    ), r__9 = (r__4 = ca * a[
						    1], dabs(r__4)) + (r__5 = 
						    ca * a[3] - wr * d2, dabs(
						    r__5)) + (r__6 = wi * d2, 
						    dabs(r__6));
...
/* Computing MAX   
   ...
   Computing MAX */
					    r__10 = (r__1 = ca * a[0] - wr * 
						    d1, dabs(r__1)) + (r__2 = 
						    ca * a[2], dabs(r__2)) + ( 						    r__3 = wi * d1, dabs(r__3) 						    ), r__11 = (r__4 = ca * a[
						    1], dabs(r__4)) + (r__5 = 
						    ca * a[3] - wr * d2, dabs(
						    r__5)) + (r__6 = wi * d2, 
						    dabs(r__6));
...
/* Computing MAX */
					...
					res /= den;
					if (dabs(x[0]) < unfl && dabs(x[1]) < 
						unfl && dabs(x[2]) < unfl &&  						dabs(x[3]) < unfl && dabs(b[0] 						) + dabs(b[1]) <= smlnum * ((
						r__1 = ca * a[0] - wr * d1, 
						dabs(r__1)) + (r__2 = ca * a[
						2], dabs(r__2)) + (r__3 = ca *
						 a[1], dabs(r__3)) + (r__4 = 
