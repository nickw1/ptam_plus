	...
	work, integer *info)
{
    ...
    static real s;
    static integer ic, jc, nc, il, ir, jr, mr, ir1, ir2, jch, llb, jkl, jku, 
	    uub, ilda, icol;
    static real temp;
    ...
    static integer ioffst, irsign;     extern /* Subroutine */ int slartg_(real *, real *, real *, real *, real * 	    ), slaset_(char *, integer *, integer *, real *, real *, real *, 
