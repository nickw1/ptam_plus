...
/* Subroutine */ int clatms_(integer *m, integer *n, char *dist, integer *
	...
	integer *kl, integer *ku, char *pack, complex *a, integer *lda,  	complex *work, integer *info  	)
{
    ...
    static complex ct;
    static integer ir, jr, mr;
    static complex st;
    static integer ir1, ir2, jch, llb, jkl, jku, uub, ilda, icol;
    static real temp;
    static logical csym;
